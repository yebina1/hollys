  ...
  const $memuData = [
    {
      ...
      nutrition: {
        ...
        rows: [
          ...
          { label: "나트륨 (mg)", hot: "0mg (0%)", icedd: "0mg (0%)" },
          { label: "당류 (g)", hot: "0g (0%)", icedd: "0g (0%)" },
        ],
      },
      allergy: null,
    },
  {
    ...
    nutrition: {
      ...
      rows: [
        ...
        { label: "나트륨 (mg)", hot: "-", iced: "250mg (13%)" },
  ...
  },
  {
    ...
    nutrition: {
      ...
      rows: [
        ...
        { label: "포화지방 (g)", hot: "-", iced: "0.0g (0%)" },
        { label: "나트륨 (mg)", hot: "-", iced: "0mg (0%)" },
        { label: "카페인 (mg)", hot: "-", iced: "-" },
      ],
    },
    allergy: null,
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "8g/15%", iced: "5g/9%" },
      { label: "포화지방 (g)", hot: "6.0g/40%", iced: "3.4g/23%" },
      { label: "나트륨 (mg)", hot: "130mg/7%", iced: "73mg/4%" },
      { label: "카페인 (mg)", hot: "153mg", iced: "153mg" },
    ],
  },
  allergy: "우유",
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "11g/20%", iced: "6g/11%" },
      { label: "포화지방 (g)", hot: "7.6g/51%", iced: "3.9g/26%" },
      { label: "나트륨 (mg)", hot: "180mg/9%", iced: "93mg/5%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "나트륨 (mg)", hot: "135mg/7%", iced: "80mg/4%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "8g/15%", iced: "5g/9%" },
      { label: "포화지방 (g)", hot: "6.0g/40%", iced: "3.3g/22%" },
      { label: "나트륨 (mg)", hot: "130mg/7%", iced: "72mg/4%" },
      { label: "카페인 (mg)", hot: "127mg", iced: "127mg" },
    ],
  },
  allergy: "우유",
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "당류 (g)", hot: "0g/0%", iced: "-" },
      { label: "단백질 (g)", hot: "0g/1%", iced: "-" },
      { label: "포화지방 (g)", hot: "0.0g/0%", iced: "-" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "포화지방 (g)", hot: "0.0g/0%", iced: "0.0g/0%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "당류 (g)", hot: "29g/29%", iced: "25g/25%" },
      { label: "단백질 (g)", hot: "9g/16%", iced: "6g/11%" },
      { label: "포화지방 (g)", hot: "6.3g/42%", iced: "4.2g/28%" },
      { label: "나트륨 (mg)", hot: "140mg/7%", iced: "94mg/5%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "10g/18%", iced: "5g/9%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "10g/18%", iced: "7g/12%" },
      { label: "포화지방 (g)", hot: "12.3g/82%", iced: "10.0g/67%" },
      { label: "나트륨 (mg)", hot: "159mg/8%", iced: "109mg/5%" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "0g (0%)", iced: "0g (0%)" },
      { label: "포화지방 (g)", hot: "0.0g (0%)", iced: "0.0g (0%)" },
...
},
{
  ...
  nutrition: {
    ...
    rows: [
      ...
      { label: "단백질 (g)", hot: "0g/1%", iced: "0g/1%" },
      { label: "포화지방 (g)", hot: "0.0g/0%", iced: "0.0g/0%" },
      { label: "나트륨 (mg)", hot: "140mg/7%", iced: "140mg/7%" },
      { label: "카페인 (mg)", hot: "-", iced: "-" },
    ],
  },
  allergy: null,
